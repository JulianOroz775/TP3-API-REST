...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2024 a las 21:56:30
...
INSERT INTO `vehiculos` (`id`, `Marca`, `Kilometros`, `Patente`, `Modelo`, `vendido`) VALUES
(5, 'Honda', 20000, 'AC-123-DB', 'Civic 2018', 0),
(7, 'Toyota', 230000, 'MFM639', 'Hilux CRV', 1),
(8, 'Ford', 120, 'LFG-270', 'Ranger 2012 2.5', 1),
(19, 'Honda', 210, 'KLX 789', 'Honda Fit 2010', 1);
